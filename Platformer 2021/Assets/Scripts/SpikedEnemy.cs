...
public class SpikedEnemy : MonoBehaviour
{
    ...
    [SerializeField] private float fallGravityScale = 5f; // Adjust this value to control the falling speed
    ...
    private void Update()
    {
            ...
            player.transform.position.x < transform.position.x + 1.0f)
        {
            ...
            rb.gravityScale = fallGravityScale; // Set the fall gravity scale
        }
